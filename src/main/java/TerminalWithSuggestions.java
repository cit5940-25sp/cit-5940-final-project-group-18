...
public class TerminalWithSuggestions {
    ...
    public TerminalWithSuggestions(GameState gameState) throws IOException {
    ...
    private void updateScreen() throws IOException {
        synchronized (screen) {
            ...
            // Render the game view below suggestions
            int gameRow = 1 + suggestions.size();
            String gameStateString = gameView.render(gameState);
            printString(0, gameRow, gameStateString);
    ...
    public static void main(String[] args) {
        try {
            ...
            GameState gameState = new GameState(players, movieDB);
            TerminalWithSuggestions app = new TerminalWithSuggestions(gameState);
            app.run();
        } catch (IOException e) {
            e.printStackTrace();
        }
